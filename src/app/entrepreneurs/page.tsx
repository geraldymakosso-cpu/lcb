...
export default function EntrepreneursPage() {
  return (
    <>
      <PageHero eyebrow="Entrepreneurs / PME" title="Donnez à votre projet les moyens d'avancer." description="LCB vous aide à clarifier votre besoin professionnel et à préparer un parcours d'étude adapté à votre activité." secondaryHref="/contact?profil=entrepreneur" imageSrc="/images/ChatGPT Image 27 août 2026, 19_17_32 (2).png" imageAlt="Entrepreneur travaillant dans une boutique textile" />
