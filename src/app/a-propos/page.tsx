...
export default function AboutPage() {
  return (
    <>
      <PageHero eyebrow="À propos de LCB" title="Une relation simple, locale et professionnelle." description={company.institutional} imageSrc="/images/equipe-commercants-marche.png" imageAlt="Équipe de commerçants réunie au marché" />
