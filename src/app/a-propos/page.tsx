...
export default function AboutPage() {
  return (
    <>
      <PageHero eyebrow="À propos de LCB" title="Une relation simple, locale et professionnelle." description={company.institutional} imageSrc="/images/ChatGPT Image 27 août 2026, 19_17_30 (1).png" imageAlt="Membre de l’équipe La Congolaise Business dans ses bureaux" />
