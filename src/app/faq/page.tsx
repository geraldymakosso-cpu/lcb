...
export default function FaqPage() {
  return (
    <>
      <PageHero eyebrow="FAQ" title="Les réponses avant votre premier échange." description="Retrouvez les informations essentielles sur les demandes, les étapes et la manière de contacter LCB." imageSrc="/images/ChatGPT Image 27 août 2026, 19_17_34 (5).png" imageAlt="Conseillère accueillant une personne pour un échange" />
