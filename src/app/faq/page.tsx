...
export default function FaqPage() {
  return (
    <>
      <PageHero eyebrow="FAQ" title="Les réponses avant votre premier échange." description="Retrouvez les informations essentielles sur les demandes, les étapes et la manière de contacter LCB." imageSrc="/images/conseillere-assistance.png" imageAlt="Conseillère répondant à un client" />
