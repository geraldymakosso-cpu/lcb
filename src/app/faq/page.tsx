...
export default function FaqPage() {
  return (
    <>
      <PageHero eyebrow="FAQ" title="Les réponses avant votre premier échange." description="Retrouvez les informations essentielles sur les demandes, les étapes et la manière de contacter LCB." imageSrc="/images/ChatGPT Image 27 août 2026, 19_37_18 (4).png" imageAlt="Conseillère accueillant un client pour un échange" />
