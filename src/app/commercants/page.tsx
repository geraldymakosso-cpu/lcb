...
export default function MerchantsPage() {
  return (
    <>
      <PageHero eyebrow="Commerçants des marchés" title="Faites avancer votre activité." description="Votre commerce a ses propres rythmes et contraintes. LCB étudie votre besoin avec une approche proche du terrain." secondaryHref="/contact?profil=commercant" />
