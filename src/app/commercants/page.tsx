...
export const metadata: Metadata = {
  ...
  description: "La Congolaise Business accompagne les commerçants des marchés de Pointe-Noire pour leurs besoins de stock, trésorerie et développement d'activité.",
...
export default function MerchantsPage() {
  return (
    <>
      ...
      <section className="section section-soft"><div className="container story-panel"><div className="story-number">01</div><div><p className="eyebrow">Proximité</p><h2>Le commerce de proximité est au cœur de La Congolaise Business.</h2><p>Les commerçants sont notre priorité. Le site, le discours et le parcours de contact sont conçus pour être simples à utiliser depuis un téléphone, même pendant une journée de travail chargée.</p><Link className="button button-primary" href="/contact?profil=commercant">Présenter mon besoin</Link></div></div></section>
    </>
  );
}
