...
export default function ContactPage() {
  return (
    <>
      <PageHero eyebrow="Contact" title="Expliquez-nous votre besoin." description="WhatsApp est le canal le plus rapide. Vous pouvez aussi appeler, vous rendre à l'agence ou transmettre une demande." imageSrc="/images/ChatGPT Image 27 août 2026, 19_17_32 (3).png" imageAlt="Équipe réunie autour d’un projet professionnel" />
