...
export default function ContactPage() {
  return (
    <>
      <section className="page-hero contact-hero"><div className="container page-hero-inner"><p className="eyebrow">Contact</p><h1>Expliquez-nous votre besoin.</h1><p className="lead">WhatsApp est le canal le plus rapide. Vous pouvez aussi appeler, vous rendre à l'agence ou transmettre une demande.</p></div></section>
